...
<template>
  <div style="flex: 0 0 100%">
    <div style="margin: 0 auto; max-width: 600px" mb-3 flex flex-wrap items-center justify-center gap-4>
      <n-form-item label="Sort keys :" label-placement="left" label-width="80" :show-feedback="false">
        <n-switch v-model:value="sortKeys" />
      </n-form-item>
      <n-form-item label="Indent size :" label-placement="left" label-width="90" :show-feedback="false">
        <n-input-number v-model:value="indentSize" min="1" max="10" style="width: 80px" />
      </n-form-item>
    </div>
  </div>
